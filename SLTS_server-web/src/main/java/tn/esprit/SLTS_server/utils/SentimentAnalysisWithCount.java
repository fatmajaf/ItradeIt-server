...
public class SentimentAnalysisWithCount {
  ...
  /***comments*****/
        ...
        map.put("negativecomments", negative2);
  		...
  		/****end comments ***/
  		/*** write in csv****/
          BufferedWriter bw = new BufferedWriter(new FileWriter("D:/jee/SLTS_server/SLTS_server-web/src/main/java/UserAnalysisFatma/res.csv"));
    ...
    //  SentimentAnalysisWithCount.commentsanalysis();
    	...
    	li.add(comment);
    	SentimentAnalysisWithCount.commentsanalysis(li);
    }

    public void trainModel() {
        InputStream dataIn = null;
        try {
            dataIn = new FileInputStream("D:/jee/SLTS_server/SLTS_server-web/src/main/java/UserAnalysisFatma/input.txt");
...
/***news*****/
     ...
     map.put("negativenews", negative2);
		...
		/****end comments ***/
		/*** write in csv****/
       BufferedWriter bw = new BufferedWriter(new FileWriter("D:/jee/SLTS_server/SLTS_server-web/src/main/java/UserAnalysisFatma/resnews.csv"));
